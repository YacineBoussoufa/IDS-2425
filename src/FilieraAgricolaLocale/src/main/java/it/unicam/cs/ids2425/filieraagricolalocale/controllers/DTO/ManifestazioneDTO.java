...
public class ManifestazioneDTO {
   ...
   private Set<String> aziendePartecipanti = new HashSet<>();
   private Set<String> personePartecipanti = new HashSet<>();
   public ManifestazioneDTO(Date data, String nome, String descrizione, int numeroMaxPartecipanti,
      POIDTO puntoDiInteresse, String animatore, Set<String> aziendePartecipanti, Set<String> personePartecipanti) {
   this.data = data;
   this.nome = nome;
   ...
   public Set<String> getAziendePartecipanti() {
      return aziendePartecipanti;
   }
   public void setAziendePartecipanti(Set<String> aziendePartecipanti) {
      this.aziendePartecipanti = aziendePartecipanti;
   }
